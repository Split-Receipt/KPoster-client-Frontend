export default defineI18nConfig(() => ({
	...
	messages: {
		...
		'en-US': {
			...
			new_password: 'New password',
			reset_password: 'Reset your password',
			email_confirmed: '¡Tu correo electrónico ha sido confirmado! Ahora puedes iniciar sesión usando el formulario de autorización con el correo electrónico y la contraseña que proporcionaste',
			help_request_description: 'Contact us in any convenient way and we will help you',
			help_request_title: 'Does the form seem complicated?',
