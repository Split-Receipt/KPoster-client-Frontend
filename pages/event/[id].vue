<template>
	<!-- <div class="event">
		...
		<div class="event__EventCard">
			<h2 class="event__EventCard-title">Información del evento</h2>
			<div class="event__EventCard-text">
				<span>
		...
		<div v-if="eventSocialMedias.length" class="event__socialMedias">
			<span class="event__socialMedias-title">redes sociales:</span>
			<div class="event__socialMedias-links">
				<cp-social-link
		...
		<div v-if="getEventCoordinates.center" class="event__map">
			<h2 class="event__map-title">Dirección del evento</h2>
			<cp-map
		...
		<div>
			<h2 class="event__map-title">Relacionados</h2>
			<div class="event__relatedList">
				<cp-huge-link-btn
					v-if="event.attributes.eventDigitalCatalog"
					class="event__relatedList-item"
		...
		<div
			...
			class="event__carousel slider-gallery"
		>
			<h2 class="event__carousel-title-gallery">Event gallery</h2>
			<cp-media-carousel
				id="qwe123"
		...
		<div class="event-contacts">
			<div class="event-contacts-title">
			...
			<div class="event-contacts-referenses">
				<div
					v-if="event.attributes.eventHost.data.attributes.contacts?.mail"
					class="event-contacts-referenses-mail"
				>
					<span class="event-contacts-referenses-mail-title">E-mail</span>
					<span class="event-contacts-referenses-mail-ref">{{
						event.attributes.eventHost.data.attributes.contacts.mail
					}}</span>
				</div>
				<div
					v-if="event.attributes.eventHost.data.attributes.contacts?.tel"
					class="event-contacts-referenses-tel"
				>
					<span class="event-contacts-referenses-tel-title">
						Número de teléfono</span
					>
					<span class="event-contacts-referenses-tel-ref">{{
						event.attributes.eventHost.data.attributes.contacts.tel
					}}</span>
				</div>
				<div
					v-if="event.attributes.eventHost.data.attributes.contacts?.place"
					class="event-contacts-referenses-place"
				>
					<span class="event-contacts-referenses-place-title">
						País y ciudad</span
					>
					<span class="event-contacts-referenses-place-ref">{{
						event.attributes.eventHost.data.attributes.contacts.place
					}}</span>
				</div>
				<div
					v-if="event.attributes.eventHost.data.attributes.socialMedias"
					class="event-contacts-referenses-socials"
				>
					<cp-social-link
	...
	<cp-base-page class="event">
		<template #content>
			...
			<div class="event__card">
				<h3 class="event__card-title">{{ $t('Información del evento') }}</h3>
